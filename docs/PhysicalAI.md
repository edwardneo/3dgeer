...
exposure poses. The existing image-based human estimator is not retrained for
fisheye images, so its predictions remain approximate. After the step creates
